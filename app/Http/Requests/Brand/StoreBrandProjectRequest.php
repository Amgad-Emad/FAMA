...
/**
 * Validates a new project. A project seeks ONE role (a single discipline) for one
 * position. Authorization is handled by the brand guard.
 */
class StoreBrandProjectRequest extends FormRequest
{
