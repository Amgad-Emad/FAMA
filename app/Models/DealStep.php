...
use App\States\DealStep\DealStepState;
use Database\Factories\DealStepFactory;
...
/**
 * Deal step (schema-master §3) — the per-deal snapshot of a flow step and the
...
{
    /** @use HasFactory<DealStepFactory> */
     ...
     */
    protected $fillable = [
        'deal_id', 'flow_step_id', 'key', 'name', 'actor', 'step_type',
    ...
    /**
     * @return BelongsTo<DealFlowStep, $this>
     */
    public function flowStep(): BelongsTo
    {
        return $this->belongsTo(DealFlowStep::class, 'flow_step_id');
    }
