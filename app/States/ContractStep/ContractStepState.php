...
namespace App\States\ContractStep;

use Spatie\ModelStates\State;
use Spatie\ModelStates\StateConfig;

/**
 * Contract-step lifecycle (talent-spec). pending → active → awaiting_action →
 * completed, with side exits skipped | rejected. Only one step per contract is
 ...
 * re-run.
 */
abstract class ContractStepState extends State
{
    ...
    /**
     * True while this step is the contract's current step (live, not yet resolved).
     */
