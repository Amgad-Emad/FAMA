...
/**
 * Deal lifecycle (talent-spec "deal loop", schema-master §3).
 *
 ...
 * status — a deal is considered initiated once it leaves draft into awaiting_*.
 */
abstract class DealState extends State
{
    ...
    /**
     * True while the deal is live and waiting on one of the parties.
     */
    ...
    /**
     * True once the deal has reached a terminal state (no further transitions).
     */
