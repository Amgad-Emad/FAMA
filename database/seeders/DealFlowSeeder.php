...
/**
 * Seeds the default "Standard Booking" deal flow — the ordered steps a deal is
 ...
 */
class DealFlowSeeder extends Seeder
{
    /**
     * Canonical steps for the standard flow. Shared with DealFlowFactory so the
    ...
    public const array STANDARD_STEPS = [
        ...
        ['key' => 'payment', 'name' => 'Deposit', 'actor' => 'brand', 'step_type' => 'payment', 'is_required' => true, 'is_skippable' => true, 'settings' => ['percentage' => 50, 'confirmation' => 'manual'], 'instructions' => 'Pay the deposit to lock the booking.'],
        ...
        ['key' => 'signoff', 'name' => 'Approve delivery', 'actor' => 'brand', 'step_type' => 'approval', 'is_required' => true, 'is_skippable' => false, 'settings' => [], 'instructions' => 'Approve the delivery to complete the deal.'],
        ['key' => 'complete', 'name' => 'Deal complete', 'actor' => 'system', 'step_type' => 'info', 'is_required' => true, 'is_skippable' => false, 'settings' => [], 'instructions' => null],
    ];

    public function run(): void
    {
        $flow = DealFlow::query()->updateOrCreate(
