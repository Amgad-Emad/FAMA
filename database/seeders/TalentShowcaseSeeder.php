...
/**
 * Ten showcase talents spanning all six skills — single- and multi-type,
...
class TalentShowcaseSeeder extends Seeder
{
    ...
    private function build(array $spec, $types): void
    {
        ...
        // Avatar image (cover/hero removed with the IG-style header — ADR-O); gallery items get their own covers.
    ...
    {
        $skills = collect($typeSlugs)->map(fn ($slug) => $types[$slug])->filter()->values();
        $allKeys = $skills->flatMap(fn ($s) => $s->default_blocks ?? [])->unique();
        ...
        // Scope-aware seeding (ADR-Q): universal talent-level blocks sit at the
        // profile level; gated blocks and galleries live in each skill's own tab.
        foreach ($skills as $skill) {
            ...
            foreach (($skill->default_blocks ?? []) as $key) {
                ...
                $universal = $blockType->availability === 'universal' && ! $blockType->is_repeatable;
                if ($universal && in_array($blockType->id, $universalOnce, true)) {
                    continue;
                }
                if ($universal) {
                    $universalOnce[] = $blockType->id;
                }
                ...
                if ($key === 'gallery' && $gallery === null) {
                    $gallery = $block; // items attach to the first tab's gallery
                }
            }
        }
    ...
    private function seedContent(Talent $talent, array $spec, ?ProfileBlock $galleryBlock): void
    {
        ...
        if ($category === 'creative') {
            ...
            // Projects belong to a skill's tab (ADR-Q) — stamp them to a creative skill.
            $creativeSkillId = $talent->talentTypes()->where('category', 'creative')->value('talent_types.id');
            Project::factory()->count($rich ? 2 : 1)->for($talent)->create(['talent_type_id' => $creativeSkillId]);
    ...
    private function talents(): array
    {
        ...
        return [
            [
                ...
                'types' => ['modeling'], 'category' => 'model', 'city' => 'Cairo', 'country' => 'Egypt',
                'depth' => 'rich',
            ...
            [
                ...
                'types' => ['photography'], 'category' => 'crew', 'city' => 'Alexandria', 'country' => 'Egypt',
                'depth' => 'rich',
            ...
            [
                ...
                'types' => ['modeling', 'styling'], 'category' => 'model', 'city' => 'Cairo', 'country' => 'Egypt',
                'depth' => 'rich',
            ...
            [
                ...
                'types' => ['cinematography'], 'category' => 'crew', 'city' => 'Giza', 'country' => 'Egypt',
                'depth' => 'rich',
            ...
            [
                ...
                'types' => ['creative-direction'], 'category' => 'creative', 'city' => 'Dubai', 'country' => 'UAE',
                'depth' => 'rich',
            ...
            [
                ...
                'types' => ['graphic-design'], 'category' => 'creative', 'city' => 'Cairo', 'country' => 'Egypt',
                'depth' => 'lean',
            ...
            [
                ...
                'types' => ['modeling'], 'category' => 'model', 'city' => 'Alexandria', 'country' => 'Egypt',
                'depth' => 'lean',
            ...
            [
                ...
                'types' => ['photography', 'cinematography'], 'category' => 'crew', 'city' => 'Cairo', 'country' => 'Egypt',
                'depth' => 'rich',
            ...
            [
                ...
                'types' => ['styling'], 'category' => 'creative', 'city' => 'Cairo', 'country' => 'Egypt',
                'depth' => 'lean',
            ...
            [
                ...
                'types' => ['modeling', 'creative-direction'], 'category' => 'model', 'city' => 'Giza', 'country' => 'Egypt',
                'depth' => 'rich',
