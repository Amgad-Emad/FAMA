...
@php
    ...
    $nav = [
        ...
        ['route' => 'discover', 'label' => __('Discover talent'), 'icon' => 'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z'],
        ['route' => 'brand.projects', 'label' => __('Projects'), 'icon' => 'M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z'],
        ['route' => 'brand.contracts', 'label' => __('Contracts'), 'icon' => 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01'],
        ...
        <div class="flex min-h-screen">
            ...
            <div class="flex min-w-0 flex-1 flex-col">
                <header class="sticky top-0 z-20 flex h-16 items-center justify-between gap-4 border-b border-line bg-bg/85 px-4 backdrop-blur sm:px-8">
                    ...
                    <div class="flex items-center gap-3">
                        @if ($brand?->is_published && $brand?->slug)
                            {{-- Quick access to the live, talent-facing public profile (published only). --}}
                            <a href="{{ route('brand.public', $brand->slug) }}" target="_blank" rel="noopener"
                               class="hidden items-center gap-1.5 rounded-pill border border-line-strong px-3 py-1.5 text-xs font-medium text-muted transition hover:border-accent hover:text-ink sm:inline-flex">
